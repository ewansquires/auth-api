...
class UserController @Autowired() (private val userService: UserService, private val authenticationService: AuthenticationService) {
  ...
  def listUsers(@RequestHeader("authorization") token: String) = {
